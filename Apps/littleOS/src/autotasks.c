...
int adding_task_thread_id = -1;

TaskRegistry autotasks[7] = {
    ...
    {"adding_task", "my task", adding_task_thread, &adding_task_thread_id},
};
...
void init_all_tasks(void) {
    ...
    adding_task_thread_id = os_create_thread("my task", adding_task_thread, NULL);
}
